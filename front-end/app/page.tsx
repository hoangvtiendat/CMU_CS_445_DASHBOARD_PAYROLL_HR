  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Shareholder Profit</CardTitle>
            <DollarSign className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>Monthly payroll distribution across departments</CardDescription>
          </CardHeader>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-1">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Work anniversaries and leave alerts</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentAlerts />
          </CardContent>
